...
namespace WPF_MoviesCRUD {
    ...
    public partial class dbMoviesDataSet : global::System.Data.DataSet {
        ...
        public partial class MovieDataTable : global::System.Data.TypedTableBase<MovieRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MovieRow AddMovieRow(string Name, int Year) {
...
namespace WPF_MoviesCRUD.dbMoviesDataSetTableAdapters {
    ...
    public partial class MovieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Movie] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Year] = @Original_Year))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Movie] ([Name], [Year]) VALUES (@Name, @Year);\r\nSELECT Id, Nam" +
                "e, Year FROM Movie WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Movie] SET [Name] = @Name, [Year] = @Year WHERE (([Id] = @Original_" +
                "Id) AND ([Name] = @Original_Name) AND ([Year] = @Original_Year));\r\nSELECT Id, Na" +
                "me, Year FROM Movie WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WPF_MoviesCRUD.Properties.Settings.Default.dbMoviesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Year FROM dbo.Movie";
